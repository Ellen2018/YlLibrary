 ...
 */
public class YlFilePrinter implements YlLogPrinter{
    private static final ExecutorService EXECUTOR = Executors.newSingleThreadExecutor();
    private final String logPath;
    private final long retentionTime;
    private LogWriter writer;
    private volatile PrintWorker worker;
    private static YlFilePrinter instance;
     ...
     */
    public static synchronized YlFilePrinter getInstance(String logPath, long retentionTime) {
        if (instance == null) {
            instance = new YlFilePrinter(logPath, retentionTime);
        }
        return instance;
    }


    private YlFilePrinter(String logPath, long retentionTime) {
    ...
    public void print(@NonNull YlLogConfig config, int level, String tag, @NonNull String printString) {
        ...
        worker.put(new YlLogBean(timeMillis, level, tag, printString));
    }

    private void doPrint(YlLogBean logMo) {
    ...
    private class PrintWorker implements Runnable {
        ...
        private BlockingQueue<YlLogBean> logs = new LinkedBlockingQueue<>();
